...
public class MainShopFragment extends Fragment
{
	...
	private void queryElecProduct()
	{
		...
		if(elecAdapter == null)
		{
			elecAdapter = new RecyclerViewAdapter(getContext(),queryProduct(ProductModel.class,map),
					dbHelper);
		}
	...
	private void queryFoodProduct()
	{
		...
		if(foodAdapter == null)
		{
			foodAdapter = new RecyclerViewAdapter(getContext(),queryProduct(ProductModel.class,map),
					dbHelper);
		}
	...
	private void queryDateUseProduct()
	{
		...
		{
			dateUseAdapter = new RecyclerViewAdapter(getContext(),
					queryProduct(ProductModel.class,map),dbHelper);
		}
	...
	private void queryWineProduct()
	{
		...
		if(wineAdapter == null)
		{
			wineAdapter = new RecyclerViewAdapter(getContext(),queryProduct(ProductModel.class,map),
					dbHelper);
		}
